...
X_train= hkl.load( 'X_LIVE_IQA_train.hkl' )
X_test= hkl.load( 'X_LIVE_IQA_test.hkl' )

Y_train= hkl.load( 'Y_LIVE_IQA_train.hkl' )
Y_test= hkl.load( 'Y_LIVE_IQA_test.hkl' )

Y_traintarget= hkl.load( 'Y_LIVE_IQA_traintarget.hkl' )
Y_testtarget= hkl.load( 'Y_LIVE_IQA_testtarget.hkl' )
...
with open("Resnet_LIVE_IQA.json", "w") as json_file:
    json_file.write(model_json)
# serialize weights to HDF5
custom_vgg_model2.save_weights("Resnet_LIVE_IQA.h5")
