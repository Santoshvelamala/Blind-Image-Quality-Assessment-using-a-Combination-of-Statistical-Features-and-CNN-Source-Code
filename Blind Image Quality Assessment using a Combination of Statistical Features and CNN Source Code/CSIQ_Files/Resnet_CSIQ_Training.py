...
X_train= hkl.load( 'X_CSIQ_train.hkl' )
X_test= hkl.load( 'X_CSIQ_test.hkl' )

Y_train= hkl.load( 'Y_CSIQ_train.hkl' )
Y_test= hkl.load( 'Y_CSIQ_test.hkl' )

Y_traintarget= hkl.load( 'Y_CSIQ_traintarget.hkl' )
Y_testtarget= hkl.load( 'Y_CSIQ_testtarget.hkl' )
print ("Files Loaded...!!!")
...
with open("Resnet_CSIQ.json", "w") as json_file:
    json_file.write(model_json)
# serialize weights to HDF5
custom_vgg_model2.save_weights("Resnet_CSIQ.h5")
