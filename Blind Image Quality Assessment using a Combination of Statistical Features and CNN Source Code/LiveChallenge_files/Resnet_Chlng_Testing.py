...
#Image_Names=si.loadmat('./ChallengeDB_release/Data/AllImages_release.mat')['AllImages_release']
...
'''
json_file = open('Resnet_Live_Chl.json', 'r')
loaded_model_json = json_file.read()
json_file.close()
model = model_from_json(loaded_model_json)

model.load_weights("Resnet_Live_Chl.h5")
